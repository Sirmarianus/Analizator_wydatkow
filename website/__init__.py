...
def create_tables():
    ...
    cursor.execute("CREATE TABLE expenses_db.wallets ( id INT NOT NULL AUTO_INCREMENT, name VARCHAR(30) user_id INT NOT NULL, type VARCHAR(30) NOT NULL, amount INT NOT NULL, currency VARCHAR(30) NOT NULL, PRIMARY KEY (id), FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE);")
